...
// 1. B Пустую папку с Новым проектом из Папки gulp-start перенести ВСЕ 3 файла!!! (gulpfile.js, package.json и папку src);
...
// 6. !!!!! Для Деплоя готового проекта на GitHub-pages РАСКОММЕНТИРОВАТЬ строку 24 ЭТОГО файла Gulpfile.js, затем в консоли VSCode ввести сначала команду npm install --save-dev gulp-gh-pages после её отработки ввести команду gulp deploy   !!!!!
